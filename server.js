...
app.post('/api/contact', async (req, res) => {
  ...
  try {
    ...
    const intentLabel = intent
      ? { hire: 'Hiring Inquiry', project: 'Technical Project', invest: 'Investment / Partnership' }[intent] ?? intent
      : 'General Inquiry'
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #f9f9f9; padding: 32px; border-radius: 8px;">
          ...
          <table style="width: 100%; border-collapse: collapse;">
            ...
            <tr>
              ...
              <td style="padding: 10px 0; border-bottom: 1px solid #eee; font-size: 14px; color: #111;"><a href="mailto:${email}" style="color: #008a4e;">${email}</a></td>
            </tr>
          </table>
